 ...
 if ((cityLimits == 'City Limits')
    ...
    && (Historic == '' || Historic == null || Historic =='-'))
    )
      {
        ...
        showMessage = true;
        cancel = true;
        comment("The parcel you have selected is either out of City Limits, a Historic Resource or a Historic District. Please contact the City for more information.");
    }
} catch (err) {
    //  cancel = true;
    //  showMessage = true;
